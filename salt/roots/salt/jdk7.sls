...
oracle-license-select:
  cmd.run:
    - unless: which java
    - name: 'echo debconf shared/accepted-oracle-license-v1-1 select true | /usr/bin/debconf-set-selections'
    - require_in:
...
oracle-license-seen-lie:
  cmd.run:
    - name: 'echo debconf shared/accepted-oracle-license-v1-1 seen true  | /usr/bin/debconf-set-selections'
    - require_in:
      - pkg: oracle-java7-installer
